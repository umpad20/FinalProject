...
export default function CreateProduct({ categories }: Props) {
    const form = useForm({
        ...
        featured: false,
        status: 'active',
        variants: [{ size: 'M', color: 'Black', color_hex: '#000000', stock: 10, sku: '' }],
        images: [] as File[],
    });
    ...
    const addVariant = () => {
        form.setData('variants', [...form.data.variants, { size: 'M', color: 'Black', color_hex: '#000000', stock: 0, sku: '' }]);
    };
    ...
    const updateVariant = (index: number, field: string, value: string | number) => {
        ...
        if (field === 'color') {
            ...
            updated[index] = { ...updated[index], color: value as string, color_hex: colorObj?.hex || '#000000' };
        } else {
                    ...
                    <div className="space-y-6 lg:col-span-2">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                                        {previews.map((src, index) => (
                                            <div key={index} className="group relative aspect-square overflow-hidden rounded-lg border border-border">
                                                ...
                                                {index === 0 && (
                                                    <span className="absolute bottom-1 left-1 rounded bg-primary px-1.5 py-0.5 text-[10px] font-medium text-primary-foreground">Primary</span>
                                                )}
                                            </div>
                                        ))}
                                    </div>
                                ...
                                {form.errors.images && <p className="mt-2 text-sm text-destructive">{form.errors.images}</p>}
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="space-y-4">
                                    ...
                                    {form.errors.variants && <p className="mt-1 text-sm text-destructive">{form.errors.variants}</p>}
                                </div>
                            </CardContent>
                        </Card>
                    </div>
