                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <Input id="email" type="email" placeholder="juan@example.com" className="mt-1" />
                                </div>
                                <div>
                                    <Label htmlFor="phone">Phone number</Label>
                                    <Input id="phone" type="tel" placeholder="+63 912 345 6789" className="mt-1" />
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <div>
                                        ...
                                        <Input id="city" placeholder="Manila" className="mt-1" />
                                    </div>
                                    <div>
                                        <Label htmlFor="province">Province / Region</Label>
                                        <Input id="province" placeholder="Metro Manila" className="mt-1" />
                                    </div>
                                </div>
                                <div className="grid gap-4 sm:grid-cols-2">
                                    <div>
                                        <Label htmlFor="postalCode">Postal code</Label>
                                        <Input id="postalCode" placeholder="1000" className="mt-1" />
                                    </div>
                                    <div>
                                        <Label htmlFor="country">Country</Label>
                                        <Input id="country" defaultValue="Philippines" className="mt-1" readOnly />
                                    </div>
                                </div>
                                <div>
                                    <Label htmlFor="notes">Order notes (optional)</Label>
                                    <Textarea id="notes" placeholder="Any special instructions..." className="mt-1" rows={3} />
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <RadioGroup value={paymentMethod} onValueChange={setPaymentMethod} className="space-y-3">
                                    <div className={`flex items-center gap-3 rounded-lg border p-4 transition-colors ${paymentMethod === 'cod' ? 'border-primary bg-primary/5' : 'border-border'}`}>
                                    ...
                                    <div className={`flex items-center gap-3 rounded-lg border p-4 transition-colors ${paymentMethod === 'gcash' ? 'border-primary bg-primary/5' : 'border-border'}`}>
                                    ...
                                    <div className={`flex items-center gap-3 rounded-lg border p-4 transition-colors ${paymentMethod === 'card' ? 'border-primary bg-primary/5' : 'border-border'}`}>
