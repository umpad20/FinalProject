...
const testimonials = [
    { name: 'Maria S.', text: 'Amazing quality clothes at great prices! Fast shipping too.', rating: 5 },
    { name: 'Juan D.', text: 'Love the minimalist designs. My go-to store for everyday wear.', rating: 5 },
    { name: 'Ana G.', text: 'The leather jacket is absolutely stunning. Exceeded my expectations.', rating: 4 },
];
...
export default function Home() {
    return (
        <StoreLayout>
            ...
            {/* Hero Section */}
            <section className="relative overflow-hidden bg-gradient-to-br from-background via-background to-muted" aria-label="Hero">
                    ...
                    <div className="grid items-center gap-12 md:grid-cols-2">
                        <div className="space-y-6">
                            ...
                            <p className="max-w-md text-lg text-muted-foreground">
                                Discover curated fashion pieces that blend comfort with style.
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <Button size="lg" variant="outline" asChild>
                                    <Link href="/shop?category=T-Shirts">Browse Collection</Link>
                                </Button>
                            </div>
                        </div>
            ...
            {/* Features */}
            <section className="border-y border-border bg-muted/50 py-8" aria-label="Features">
            ...
            {/* Featured Products */}
            <section className="bg-muted/30 py-16" aria-label="Featured products">
                <div className="mx-auto max-w-7xl px-4">
                    <div className="mb-8 flex items-center justify-between">
                        <div>
                            <h2 className="text-2xl font-bold">Featured Products</h2>
                            <p className="mt-1 text-muted-foreground">Our hand-picked favorites</p>
                        </div>
                        <Button variant="ghost" asChild>
                            <Link href="/shop">
                                View All <ArrowRight className="ml-1 h-4 w-4" />
                ...
                <div className="mx-auto max-w-7xl px-4">
                    <div className="relative overflow-hidden rounded-2xl bg-primary px-8 py-16 text-primary-foreground md:px-16">
                        <div className="relative z-10 max-w-lg">
                            <p className="mb-2 text-sm font-medium uppercase tracking-wider opacity-80">Limited Time Offer</p>
                            <h2 className="mb-4 text-3xl font-bold md:text-4xl">
                                Get 20% Off Your First Order
                            </h2>
                            <p className="mb-6 opacity-90">
                                Sign up today and receive an exclusive discount on your first purchase.
                                Don&apos;t miss out on premium fashion at unbeatable prices.
                            </p>
                        ...
                        <div className="absolute -bottom-16 -right-8 h-48 w-48 rounded-full bg-white/5" />
                    </div>
                </div>
            </section>

            {/* Testimonials */}
            <section className="bg-muted/30 py-16" aria-label="Customer testimonials">
                <div className="mx-auto max-w-7xl px-4">
                    <div className="mb-8 text-center">
                        <h2 className="text-2xl font-bold">What Our Customers Say</h2>
                        <p className="mt-1 text-muted-foreground">Real reviews from real people</p>
                    </div>
                ...
                <div className="mx-auto max-w-7xl px-4">
                    <div className="mb-8 flex items-center justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-muted-foreground">Fresh drops this season</p>
                        </div>
                        <Button variant="ghost" asChild>
                            <Link href="/shop">
                                View All <ArrowRight className="ml-1 h-4 w-4" />
