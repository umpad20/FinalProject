                    ...
                    <div className="grid gap-8 lg:grid-cols-3">
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="hidden border-b border-border pb-3 md:grid md:grid-cols-12 md:gap-4">
                                <span className="col-span-6 text-sm font-semibold text-muted-foreground">Product</span>
                                <span className="col-span-2 text-center text-sm font-semibold text-muted-foreground">Price</span>
                                <span className="col-span-2 text-center text-sm font-semibold text-muted-foreground">Quantity</span>
                                <span className="col-span-2 text-right text-sm font-semibold text-muted-foreground">Total</span>
                            </div>

                            <div className="divide-y divide-border">
                                {items.map((item) => (
                                    <div key={item.id} className="grid items-center gap-4 py-6 md:grid-cols-12">
                                        {/* Product */}
                                        <div className="col-span-6 flex items-center gap-4">
                                            <Link href={`/shop/${item.product.slug}`} className="h-24 w-20 shrink-0 overflow-hidden rounded-lg bg-muted">
                                                <img
